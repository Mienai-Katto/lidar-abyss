...
@onready var extraction_area = get_node("/root/Map-01/Extração/Extraction")
@onready var static_body_extraction = get_node("/root/Map-01/Extração/Extraction/StaticBody3D")
var inventory: Array = []
